...
@section('content')
    <style>
        ...
        .tariff-card-content a {
            color: #0059ff; /* Цвет текста ссылки */
            text-decoration: none; /* Убираем подчеркивание */
            font-size: 16px; /* Размер шрифта */
            font-weight: 500; /* Жирность шрифта */
            line-height: 1.5; /* Высота строки */
            transition: color 0.3s ease, background-color 0.3s ease; /* Плавный переход цвета при наведении */
        }
    ...
    <div class="container my-5">
        <h2 class="text-center">Вантажоперевезення по Україні - <strong>перевезення вантажів недорого:</strong></h2>
        <div class="tariff-card mt-4">
            ...
            <div class="tariff-card-content">
                ...
                <ul>
                    ...
                    <li><a href="{{route('moving')}}">Квартирні та офісні переїзди</a></li>
                    <li><a href="{{route('loadingUnloading')}}">Завантаження-розвантаження, підйом,збирання-розбирання меблів</a></li>
    ...
    <div class="container my-5">
        <h2 class="text-center">Якісна робота, комерційні вантажоперевезення:</h2>
        <div class="tariff-card mt-4">
            <img src="{{ asset('images/logo6.jpg') }}" alt="Вантажник" />
            <div class="tariff-card-content">
                <p class="orange-text"><strong>Транспортна компанія «Perevozchik» багато років працює на українському ринку, надаючи повний сервіс послуг вантажоперевезень:</strong></p>
                <ul>
