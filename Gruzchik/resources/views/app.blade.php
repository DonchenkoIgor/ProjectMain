...
@section('content')
    ...
    <div class="container my-5">
        ...
        <div class="tariff-card mt-4">
            ...
            <div class="tariff-card-content">
                <p class="orange-text"><strong>Транспортна компанія «Gruzchik» багато років працює на українському ринку, надаючи повний сервіс послуг вантажоперевезень:</strong></p>
                <ul>
